...
def extract_features(config):
    ...
    img_dir = f'/data/code/ZSL_Code/ZSL_Data/{config.dataset}'
    file_paths = f'/data/code/ZSL_Code/ZSL_Data/xlsa17/data/{config.dataset}/res101.mat'
    ...
    split_path = os.path.join(f'/data/code/ZSL_Code/ZSL_Data/xlsa17/data/{config.dataset}/att_splits.mat')
...
if __name__=='__main__':
    ...
    parser.add_argument('--nun_workers', '-n', type=int, default='2')
